...
<script  type="text/javascript" charset="utf-8">
	...
	function checked(num){
		$('#check'+num).click(function(){
			...
			var url = baseurl_checked+$(this).data('title')+'/'+$(this).data('idjournal')+'/'+$(this).data('idreviewer');
			var n=0;
			$('.div_modal').html('');
    					...
    					<tbody>
    						...
    						<tr>
    							...
    							<td class="pull-right">
    								...
    								<button type="button" class="btn btn-primary btn-xs check" id="check<?php echo $num;?>" data-title="<?php echo $read['j_title'];?>" data-idreviewer="<?php echo $read['id_reviewer']; ?>" data-idjournal="<?php echo $read['id_journal']; ?>">CHECK</button>
    							</td>
    						</tr>
    					<?php endforeach;?>
    				</tbody>
